 ...
 * @returns 文件 hash
 */
export function calculateFileHash(file: File, onProgress?: HashProgressCallback): Promise<string> {
 ...
 * @returns 分片数组
 */
export function createFileChunks(file: File, chunkSize: number = 5 * 1024 * 1024): FileChunk[] {
